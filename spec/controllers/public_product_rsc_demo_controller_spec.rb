...
describe PublicProductRscDemoController, type: :controller, inertia: true do
  ...
  describe "GET performance_demo" do
    it "renders a logged-out public performance lab for product and Discover route pairs" do
      ...
      expect(response.body).to include("PR 69 media-bearing same-fixture ShakaPerf A/B")
      expect(response.body).to include("PR 69 media-bearing A/B summary")
      expect(response.body).to include("stable deployed pre-media A/B summary")
      ...
      expect(response.body).to match(/review-app reruns do not measure the\s+stable deployed pre-media fixture/)
      expect(response.body).to include("1292.15 ms")
      expect(response.body).to include("Needs media parity")
      expect(response.body).to include("Known invalid comparison today")
      ...
      expect(response.body).to include("-43.4%")
      expect(response.body).to include("-25.9%")
