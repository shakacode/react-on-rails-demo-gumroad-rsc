...
describe PublicProductRscDemoPresenter do
  ...
  describe "#react_stack_versions" do
    it "reports the React on Rails Pro and React 19 RSC package line used by the demo" do
      ...
      expect(versions[:react_on_rails_pro_gem]).to eq("17.1.0.rc.3")
      expect(versions[:react_on_rails_pro_npm]).to eq("17.1.0-rc.3")
      expect(versions[:react_on_rails_rsc]).to eq("19.3.0-rc.3")
    end
  end
