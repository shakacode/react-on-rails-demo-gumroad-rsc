...
Naming correction: these artifacts were generated by
`scripts/perf/compare_dashboard_routes.rb` using Ruby, Selenium, and
ChromeDriver. They were historically described as "ShakaPerf" in the UI and
PR text, but they were not produced by the `shaka-perf` CLI.
