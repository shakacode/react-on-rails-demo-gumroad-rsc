...
- the new production-shaped product and Discover routes have supplied a deployed headless-browser benchmark, but not yet valid mobile-throttled PageSpeed evidence with media parity
